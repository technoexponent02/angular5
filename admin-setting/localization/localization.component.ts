...
import * as countryConfig from '../../../countryConfig';
...
export class LocalizationComponent implements OnInit {
  ...
  addCurrencyObj: any;
  /**
   * @property \{{{any}}\} {{countryFlagAndData}} {{this will hold the all country data with flag}}
   */
  countryFlagAndData: any = [];

  countryConfigFlagData: any = countryConfig.countryFlagData;
  ...
  addLanguageSave(){
    ...
    if(this.addedLanguageObj.status == true){
      addLangObj = {
        ...
        picture: this.addedLanguageObj.picture
      }
    }
  ...
  ngOnInit() {
    ...
    // cuntry flag and data
    // this.userService.getAllCoutryFlagData()
    //   .subscribe(
    //     data => {
    //       this.countryFlagAndData = data;
    //       // console.log(this.countryFlagAndData);
    //     },
    //     error => {
    //       console.log(error);
    //       alert('Something went wrong!');
    ...
    this.countryFlagAndData = this.countryConfigFlagData;
