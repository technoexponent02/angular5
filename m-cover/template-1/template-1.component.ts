...
export class Template1Component implements OnInit {
  ...
  receiveUploadedDataAndState($event) {
     ...
     * @todo
     */
    // console.log($event.whichImage, $event.imagesource.image);
  ...
  ngOnInit() {
    ...
    this.templateModel.about = JSON.parse(localStorage.getItem('YamubaHeaderCover')).about;
